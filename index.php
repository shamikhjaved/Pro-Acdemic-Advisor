        ...
        <div class="row">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h1>Welcome Dashboard</h1>
                   <p>Data Is Summarized For You</p>
                </div>
                <div>
          ...
          <div class="row">
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h2 class="card-title" style="color: #00337c;">Sign Up Details</h2>
            ...
            ?>
                  ...
                  if ($result->num_rows > 0) {
                      while($row = $result->fetch_assoc()) {
                          echo "<tr><td>" . $row["Id"] . "</td><td>" . $row["fullname"] . "</td><td>" . $row["email"] . "</td><td>" . $row["cnumber"] . "</td></tr>";
                      }
                  } else {
...
$result = $conn->query($sql);
                  ...
                  if ($result->num_rows > 0) {
                      while($row = $result->fetch_assoc()) {
                          echo "<tr><td>" . $row["Id"] . "</td><td>" . $row["name"] . "</td><td>" . $row["email"] . "</td><td>" . $row["cnumber"] . "</td><td>" . $row["message"] . "</td></tr>";
                      }
                  } else {
                      echo "<tr><td colspan='3'>No results found</td></tr>";
                  }
